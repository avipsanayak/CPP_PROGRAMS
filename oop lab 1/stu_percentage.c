...
void TotalMarksPercentageStudents(struct Student students[], int numberStudents)
{
    int i, m;
...
void AscendingOrder(struct Student students[], int numberStudents)
{
    int i, j, m;
...
void main()
{
    ...
    TotalMarksPercentageStudents(students, numberStudents);
    ...
    AscendingOrder(students, numberStudents);
    printf("\n");
    getch();
}